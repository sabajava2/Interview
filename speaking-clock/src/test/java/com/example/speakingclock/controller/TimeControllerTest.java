...
public class TimeControllerTest {
    ...
    @Test
    public void testConvertToDay_Success() {
        String timeStr = "12:00";
        String expectedResponse = "It's Midday";

        when(timeService.convertToDay(timeStr)).thenReturn(expectedResponse);

        ResponseEntity<String> response = timeController.convertToDay(timeStr);
    ...
    @Test
    public void testConvertToDay_InvalidFormat() {
        String timeStr = "08:34:59";
